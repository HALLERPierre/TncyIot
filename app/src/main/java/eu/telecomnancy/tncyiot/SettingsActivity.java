...
public class SettingsActivity extends PreferenceActivity {
    /**
     * Determines whether to always show the simplified activity_settings UI, where
     * activity_settings are presented in a single list. When false, activity_settings are shown
